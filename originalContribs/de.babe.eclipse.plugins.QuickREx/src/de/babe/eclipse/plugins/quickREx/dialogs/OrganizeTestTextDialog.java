...
public class OrganizeTestTextDialog extends Dialog {
   ...
   * 
	...
	/**
   * Returns the selected text or <code>null</code> if a button other 
   * than 'ok' was pressed (or the dialog is not in 'LOAD'-mode)
   * 
   ...
   * 
	 * @param p_text the text to be saved
	 */
  ...
  /* (non-Javadoc)
	...
	/**
   * Returns the NamedText (name and contents of a piece of text) to be saved or 
   * <code>null</code> if a button other than 'ok' was pressed or the dialog is
   * not in 'SAVE'-mode
   * 
